					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									đ  <?php echo htmlentities($rws['productPrice']);?>.000
								</span>
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Thêm Vào Giỏ Hàng</button></a>
								<?php } else {?>
							<div class="action" >Thêm Vào Giỏ Hàng</div>
					<?php } ?>
								...
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											...
											{
												echo htmlentities("Còn Hàng");
											}
											else
											{
												echo htmlentities("Hết Hàng");
											}
                                            //echo htmlentities($row['productAvailability']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value">
												<spab> </spab><?php echo htmlentities($row['productCompany']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">đ <?php echo htmlentities($row['productPrice']);?>.000</span>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fab fa-facebook-f" href="https://www.facebook.com/NguyenLamThanhLong"></a></li>
						                <li><a class="fab fa-instagram" href="https://www.instagram.com/longndp?utm_source=qr"></a></li>
						                <li><a class="fab fa-tiktok" href="https://www.tiktok.com/@longndp_?lang=en"></a></li>
						                <li><a class="fab fa-linkedin" href="https://www.linkedin.com/in/nguy%E1%BB%85n-l%C3%A2m-th%C3%A0nh-long-098562223/"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Hài Lòng</td>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Xác Nhận</button>
														</div><!-- /.action -->
