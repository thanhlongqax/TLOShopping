...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> COD (thanh toán khi nhận hàng)
	     ...
	     <input type="submit" value="Đặt Hàng" name="submit" class="btn btn-primary">
