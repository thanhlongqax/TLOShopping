			...
			<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
				...
				<div class="logo">
					<a href="index.php">
						...
						<h2><img src="./img/cart.svg" width="35" height="30"> TLO Shopping</h2>
			...
			<div class="col-xs-12 col-sm-12 col-md-6 top-search-holder">
				<div class="search-area" id="search-area">
					<form name="search" method="post" action="search-result.php">
							<input class="search-field" placeholder="Tìm kiếm ở đây" name="product"
								required="required" />
								<button type="submit" name="search"><img src="./img/search.svg"></button>
					</form>
							...
							if (!empty($query)) {
								...
								<div class="clearfix cart-total">
									<div class="pull-right">
										...
										<span class="text">Tổng :</span><span class='price'>đ.
