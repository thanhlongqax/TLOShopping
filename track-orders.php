...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Vui lòng nhập ID đơn hàng của bạn vào ô bên dưới và nhấn Enter. Điều này đã được trao cho bạn trên biên nhận của bạn và trong email xác nhận.</span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Mã Vận Đơn</label>
