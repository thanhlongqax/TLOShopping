...
$_SESSION['msg']="Danh Mục Phụ Đã Thêm Thành Công !!";
...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Danh Mục Phụ Đã Xóa !!";
		  }
...
<head>
	...
	<title>Admin| Danh Mục Phụ</title>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn Có Muốn Xóa Không ?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
