...
$_SESSION['msg']="Danh Mục Đã Cập Nhật !!";
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn Có Muốn Xóa Không ?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
