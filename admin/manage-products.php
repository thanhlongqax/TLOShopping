...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Sản Phẩm Đã Xóa !!";
		  }
...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn Có Muốn Xóa ?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
