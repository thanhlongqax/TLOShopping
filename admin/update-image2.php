...
$_SESSION['msg']="Hình ảnh sản phẩm được cập nhật thành công !!";
...
<head>
	...
	<title>Admin| Cập Nhật Hình Ảnh Sản Phẩm</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Hình Ảnh Sản Phẩm Hiện Tại 2</label>
<div class="controls">
