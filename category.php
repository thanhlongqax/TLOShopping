...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Mục Lục</div>        
...
while($row=mysqli_fetch_array($sql))
{
	...
	<div class="accordion-heading">
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle" id="dropdown-toggle">
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">TLO Shopping</h3>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="180" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div>
