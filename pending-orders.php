...
<html lang="en">
	<head>
	    ...
	    <title>Lịch sử đặt hàng đang chờ xử lý</title>
...
<form name="cart" method="post">	
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Đon vị</th>
					...
					<th class="cart-total item">Hình Thức Thanh Toán</th>
					<th class="cart-description item">Lịch Sử Giao Dịch</th>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Tiến Hình Thanh Toán</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Không có kết quả tìm thấy</h4></td>
</tr>
<?php } ?>
