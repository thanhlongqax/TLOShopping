				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Tiếp Tục Mua Hàng</a>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>" >
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="114" height="200">
						</a>
					</td>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Tên Người Nhận<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Số Điện Thoại <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Địa Chỉ<span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Tên Người Nhận<span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Tổng<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
