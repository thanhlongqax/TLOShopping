...
<body class="cnt-home">
	...
	<!-- ============================================== HEADER : END ============================================== -->
	<div class="slider" id="slider" style="text-align:center;">
		<picture>
		<source media="(max-width :200px" srcset="./assets/images/sliders/banner-200.jpg" />
		<source media="(max-width :400px" srcset="./assets/images/sliders/banner-400.jpg" />
			<source media="(max-width :500px" srcset="./assets/images/sliders/banner-500.jpg" />
			<source media="(max-width :1000px" srcset="./assets/images/sliders/banner-800.jpg" />
			<source media="(max-width :1200px" srcset="./assets/images/sliders/banner-1200.jpg" />
			<source media="(min-width :1200px" srcset="./assets/images/sliders/banner-1920.jpg" />
			<img src="./assets/images/sliders/banner-1920.jpg" alt="">
		</picture>
	</div>
	...
	<div class="body-content outer-top-xs" id="top-banner-and-menu">
		<div class="container">
			<div class="furniture-container homepage-container">
				...
				<!-- ================================== TOP NAVIGATION : END ================================== --><!-- /.sidemenu-holder -->
								...
								<div class="hidden-md col-sm-4 col-lg-4">
									<div class="info-box">
										<div class="row">
											...
											<div class="col-xs-10">
												<h4 class="info-box-heading orange">Miễn Phí Giao Hàng</h4>
											</div>
										</div>
										<h6 class="text">Giao hàng miễn phí trên đơn hàng 4 triệu đồng</h6>
									</div>
								</div><!-- .col -->
								...
								<div class="col-md-6 col-sm-4 col-lg-4">
									<div class="info-box">
										<div class="row">
											...
											<div class="col-xs-10">
												<h4 class="info-box-heading red">Voucher Đặc Biệt</h4>
											</div>
										</div>
