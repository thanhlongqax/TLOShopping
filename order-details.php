				...
				<tr>
					...
					<td class="cart-image">
                        <a class="entry-thumbnail" href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>" >
						    <img src="admin/productimages/<?php echo $row['pid'];?>/<?php echo $row['pimg1'];?>" alt="" width="114" height="200">
						</a>
					</td>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">Id Đơn Đặt Hàng hoặc Địa Chỉ Email Không Hợp Lệ</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
