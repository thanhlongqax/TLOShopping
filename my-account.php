...
<div class="form-group">
					    <label class="info-title" for="Current Password">Nhập password Hiện tại<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">Nhập password mới <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Xác nhận password <span>*</span></label>
